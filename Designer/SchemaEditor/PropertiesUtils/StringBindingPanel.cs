			...
			if (bind != null)
			{
				...
				foreach (System.Windows.Data.BindingBase bindingBase in bind.Bindings)
				{
					if (bindingBase is System.Windows.Data.Binding)
					{
						...
						if (b.Source is ObjectDataProvider && ((ObjectDataProvider)b.Source).ObjectInstance is ChannelDataSource)
						{
							ChannelDataSource src = ((ObjectDataProvider)b.Source).ObjectInstance as ChannelDataSource;
							channels.Add(src.GetChannel());
						}
					}
				}
				FillChannelsGrid();
